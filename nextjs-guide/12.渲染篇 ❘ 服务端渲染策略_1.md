...
![12-1.gif](../assets/12-1.gif)

现在让我们运行 `npm run build && npm run start`，然而此时每次刷新都还是这张 emo 的猫猫：

![12-2.gif](../assets/12-2.gif)

这是为什么呢？

让我们看下构建时的输出结果：

![image](https://s2.loli.net/2025/01/29/YcVAsuOZ2h6GlIQ.png)
...
![image](https://s2.loli.net/2025/01/29/gXKw7cqNxrpSIRH.png)

访问效果如下：

![12-4.gif](../assets/12-4.gif)
...
![image](https://s2.loli.net/2025/01/29/AI5buoMNxy6P1n7.png)

但是图片却没有在页面刷新的时候改变（此时又是一只 emo 的猫猫）：

![12-5.gif](../assets/12-5.gif)
...
![image](https://s2.loli.net/2025/01/29/wN8LfGETK7r391n.png)
