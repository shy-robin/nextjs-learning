...
![image](https://s2.loli.net/2025/01/29/sEn4gPW1RhABb5V.png)
...
![image](https://s2.loli.net/2025/01/29/s5exifKrwkQObZ4.png)
...
![image](https://s2.loli.net/2025/01/29/8jpEYzBTtfoXNUG.png)
...
![image](https://s2.loli.net/2025/01/29/bE2muBoFOrDVUhW.png)

访问 `/server` 的时候，浏览器不会有任何打印：

![image](https://s2.loli.net/2025/01/29/M9FUEZs5n4mDfvj.png)

客户端组件在浏览器中打印，这可以理解，毕竟它是客户端组件，当然要在客户端运行。可是客户端组件为什么在编译的时候会运行一次呢？让我们看下 `/client` 的返回：

![image](https://s2.loli.net/2025/01/29/6tS1IxJUvQ3lr9u.png)
...
实际开发的时候，不可能纯用服务端组件或者客户端组件，当交替使用的时候，一定要注意一点，那就是：**服务端组件可以直接导入客户端组件，但客户端组件并不能导入服务端组件**
...
![image](https://s2.loli.net/2025/01/29/UgdkB6yAGQDCHtc.png)
...
![image](https://s2.loli.net/2025/01/29/h2iWAfFIJdeEGmw.png)
